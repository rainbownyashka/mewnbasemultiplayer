...
- Added dynamic planet climate hooks (day/night + weather influence on temperature, meteor spawn rate, weather/lightning frequency multipliers) and random-world launcher bat (2026-03-30).
...
- Dynamic temperature/weather/meteor behavior not yet verified in-game.
- run_random_world.bat not yet verified.
