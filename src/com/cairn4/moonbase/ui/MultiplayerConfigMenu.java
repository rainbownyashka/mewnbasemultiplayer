...
public class MultiplayerConfigMenu extends Menu {
    ...
    protected void setup() {
        ...
        final TextField ipField = new TextField("127.0.0.1", textFieldStyle);
        final TextField portField = new TextField("7777", textFieldStyle);
    final TextField nickField = new TextField(System.getProperty("user.name", "Player"), textFieldStyle);
