...
extends HabitatModule {
    ...
    public ChemistryLab(World world, Chunk chunk, int x, int y) {
        ...
        this.componentImage = new Image(world.gameScreen.skin.getDrawable("chemistrylab"));
        ...
        this.itemCrafter.soundFinishBuilding = "sounds/crafter-bubbles.ogg";
    ...
    public void interact(Player player) {
        if (this.hasDisaster()) {
            ...
            if (ic != null) {
                ...
                MoonBase.error("Chemistrylab: no ItemCrafter behavior");
            }
        }
    }
    ...
    private void toggleFx(boolean building) {
        if (building) {
            this.componentImage.setDrawable(this.world.gameScreen.skin.getDrawable("chemistrylab"));
            if (this.bubblefx.pfx.isComplete()) {
                this.bubblefx.pfx.start();
            }
        } else {
            this.componentImage.setDrawable(this.world.gameScreen.skin.getDrawable("chemistrylab-off"));
