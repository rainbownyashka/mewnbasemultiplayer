...
extends BaseModule {
    ...
    public ConstructionYard(World world, Chunk chunk, int x, int y) {
    ...
    protected void setBuilderId() {
        this.builderId = "constructionyard";
    }

    @Override
    protected void createDrawables() {
        super.createDrawables("constructionyard", this.world.gameScreen.mainGroup);
    ...
    public void setupSpineActor() {
        this.spineActor = new SpineActor("constructionyard", true, 0.5f, this.world.gameScreen.skeletonRenderer);
