...
extends BaseModule {
    ...
    public Battery(World world, Chunk chunk, int x, int y) {
        ...
        this.powerStorageBehavior.capacity = 750.0f;
    ...
    protected void createDrawables() {
        super.createDrawables("battery", this.world.gameScreen.mainGroup);
