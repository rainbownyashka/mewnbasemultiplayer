...
public enum SteamResult {
    ...
    static {
        SteamResult[] values = SteamResult.values();
        int maxResultCode = 0;
        ...
        SteamResult[] steamResultArray = values;
        int n = steamResultArray.length;
        for (int i = 0; i < n; ++i) {
            SteamResult value;
            SteamResult.valuesLookupTable[value.code] = value = steamResultArray[i];
        }
    }
}
