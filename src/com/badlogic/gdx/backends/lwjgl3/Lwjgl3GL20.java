...
implements com.badlogic.gdx.graphics.GL20 {
    ...
    public void glShaderSource(int shader, String string) {
        GL20.glShaderSource(shader, (CharSequence)string);
    }
    ...
    public void glUniform1fv(int location, int count, float[] v, int offset) {
        GL20.glUniform1fv(location, this.toFloatBuffer(v, offset, count));
    }
    ...
    public void glUniform1iv(int location, int count, int[] v, int offset) {
        GL20.glUniform1iv(location, this.toIntBuffer(v, offset, count));
    }
    ...
    public void glUniform2fv(int location, int count, float[] v, int offset) {
        GL20.glUniform2fv(location, this.toFloatBuffer(v, offset, count << 1));
    }
    ...
    public void glUniform2iv(int location, int count, int[] v, int offset) {
        GL20.glUniform2iv(location, this.toIntBuffer(v, offset, count << 1));
    }
    ...
    public void glUniform3fv(int location, int count, float[] v, int offset) {
        GL20.glUniform3fv(location, this.toFloatBuffer(v, offset, count * 3));
    }
    ...
    public void glUniform3iv(int location, int count, int[] v, int offset) {
        GL20.glUniform3iv(location, this.toIntBuffer(v, offset, count * 3));
    }
    ...
    public void glUniform4fv(int location, int count, float[] v, int offset) {
        GL20.glUniform4fv(location, this.toFloatBuffer(v, offset, count << 2));
    }
    ...
    public void glUniform4iv(int location, int count, int[] v, int offset) {
        GL20.glUniform4iv(location, this.toIntBuffer(v, offset, count << 2));
    }
    ...
    public void glUniformMatrix2fv(int location, int count, boolean transpose, float[] value, int offset) {
        GL20.glUniformMatrix2fv(location, transpose, this.toFloatBuffer(value, offset, count << 2));
    }
    ...
    public void glUniformMatrix3fv(int location, int count, boolean transpose, float[] value, int offset) {
        GL20.glUniformMatrix3fv(location, transpose, this.toFloatBuffer(value, offset, count * 9));
    }
    ...
    public void glUniformMatrix4fv(int location, int count, boolean transpose, float[] value, int offset) {
        GL20.glUniformMatrix4fv(location, transpose, this.toFloatBuffer(value, offset, count << 4));
    }
