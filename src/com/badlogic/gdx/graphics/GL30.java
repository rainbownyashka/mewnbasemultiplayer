...
extends GL20 {
    ...
    public void glDrawRangeElements(int var1, int var2, int var3, int var4, int var5, int var6);
    ...
    public void glTexImage3D(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10);
    ...
    public void glTexSubImage3D(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11);
    ...
    public Buffer glGetBufferPointerv(int var1, int var2);
    ...
    public void glBlitFramebuffer(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10);

    public void glRenderbufferStorageMultisample(int var1, int var2, int var3, int var4, int var5);

    public void glFramebufferTextureLayer(int var1, int var2, int var3, int var4, int var5);

    public Buffer glMapBufferRange(int var1, int var2, int var3, int var4);

    public void glFlushMappedBufferRange(int var1, int var2, int var3);

    public void glBindVertexArray(int var1);

    public void glDeleteVertexArrays(int var1, int[] var2, int var3);

    public void glDeleteVertexArrays(int var1, IntBuffer var2);

    public void glGenVertexArrays(int var1, int[] var2, int var3);

    public void glGenVertexArrays(int var1, IntBuffer var2);

    public boolean glIsVertexArray(int var1);

    public void glBeginTransformFeedback(int var1);

    public void glEndTransformFeedback();

    public void glBindBufferRange(int var1, int var2, int var3, int var4, int var5);

    public void glBindBufferBase(int var1, int var2, int var3);

    public void glTransformFeedbackVaryings(int var1, String[] var2, int var3);

    public void glVertexAttribIPointer(int var1, int var2, int var3, int var4, int var5);

    public void glGetVertexAttribIiv(int var1, int var2, IntBuffer var3);

    public void glGetVertexAttribIuiv(int var1, int var2, IntBuffer var3);

    public void glVertexAttribI4i(int var1, int var2, int var3, int var4, int var5);

    public void glVertexAttribI4ui(int var1, int var2, int var3, int var4, int var5);

    public void glGetUniformuiv(int var1, int var2, IntBuffer var3);

    public int glGetFragDataLocation(int var1, String var2);

    public void glUniform1uiv(int var1, int var2, IntBuffer var3);

    public void glUniform3uiv(int var1, int var2, IntBuffer var3);

    public void glUniform4uiv(int var1, int var2, IntBuffer var3);

    public void glClearBufferiv(int var1, int var2, IntBuffer var3);

    public void glClearBufferuiv(int var1, int var2, IntBuffer var3);

    public void glClearBufferfv(int var1, int var2, FloatBuffer var3);

    public void glClearBufferfi(int var1, int var2, float var3, int var4);

    public String glGetStringi(int var1, int var2);

    public void glCopyBufferSubData(int var1, int var2, int var3, int var4, int var5);

    public void glGetUniformIndices(int var1, String[] var2, IntBuffer var3);

    public void glGetActiveUniformsiv(int var1, int var2, IntBuffer var3, int var4, IntBuffer var5);

    public int glGetUniformBlockIndex(int var1, String var2);

    public void glGetActiveUniformBlockiv(int var1, int var2, int var3, IntBuffer var4);

    public void glGetActiveUniformBlockName(int var1, int var2, Buffer var3, Buffer var4);

    public String glGetActiveUniformBlockName(int var1, int var2);

    public void glUniformBlockBinding(int var1, int var2, int var3);

    public void glDrawArraysInstanced(int var1, int var2, int var3, int var4);

    public void glDrawElementsInstanced(int var1, int var2, int var3, int var4, int var5);

    public void glGetInteger64v(int var1, LongBuffer var2);

    public void glGetBufferParameteri64v(int var1, int var2, LongBuffer var3);

    public void glGenSamplers(int var1, int[] var2, int var3);

    public void glGenSamplers(int var1, IntBuffer var2);

    public void glDeleteSamplers(int var1, int[] var2, int var3);

    public void glDeleteSamplers(int var1, IntBuffer var2);

    public boolean glIsSampler(int var1);

    public void glBindSampler(int var1, int var2);

    public void glSamplerParameteri(int var1, int var2, int var3);

    public void glSamplerParameteriv(int var1, int var2, IntBuffer var3);

    public void glSamplerParameterf(int var1, int var2, float var3);

    public void glSamplerParameterfv(int var1, int var2, FloatBuffer var3);

    public void glGetSamplerParameteriv(int var1, int var2, IntBuffer var3);

    public void glGetSamplerParameterfv(int var1, int var2, FloatBuffer var3);

    public void glVertexAttribDivisor(int var1, int var2);

    public void glBindTransformFeedback(int var1, int var2);

    public void glDeleteTransformFeedbacks(int var1, int[] var2, int var3);

    public void glDeleteTransformFeedbacks(int var1, IntBuffer var2);

    public void glGenTransformFeedbacks(int var1, int[] var2, int var3);

    public void glGenTransformFeedbacks(int var1, IntBuffer var2);

    public boolean glIsTransformFeedback(int var1);

    public void glPauseTransformFeedback();

    public void glResumeTransformFeedback();

    public void glProgramParameteri(int var1, int var2, int var3);

    public void glInvalidateFramebuffer(int var1, int var2, IntBuffer var3);

    public void glInvalidateSubFramebuffer(int var1, int var2, IntBuffer var3, int var4, int var5, int var6, int var7);
