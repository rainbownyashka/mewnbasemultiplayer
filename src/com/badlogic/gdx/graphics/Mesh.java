...
implements Disposable {
    ...
    public float[] getVertices(int srcOffset, int count, float[] vertices, int destOffset) {
        ...
        FloatBuffer verticesBuffer = this.getVerticesBuffer(false);
    ...
    public void getIndices(int srcOffset, int count, short[] indices, int destOffset) {
        ...
        ShortBuffer indicesBuffer = this.getIndicesBuffer(false);
    ...
    public void bind(ShaderProgram shader, int[] locations, int[] instanceLocations) {
    ...
    public VertexAttributes getInstancedAttributes() {
        return this.instances != null ? this.instances.getAttributes() : null;
    }
    ...
    public void calculateBoundingBox(BoundingBox bbox) {
        ...
        FloatBuffer verts = this.vertices.getBuffer(false);
        bbox.inf();
    ...
    public BoundingBox extendBoundingBox(BoundingBox out, int offset, int count, Matrix4 transform) {
        ...
        FloatBuffer verts = this.vertices.getBuffer(false);
        ShortBuffer index = this.indices.getBuffer(false);
        VertexAttribute posAttrib = this.getVertexAttribute(1);
