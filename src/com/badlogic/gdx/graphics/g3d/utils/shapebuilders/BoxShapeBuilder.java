...
extends BaseShapeBuilder {
    public static void build(MeshPartBuilder builder, BoundingBox box) {
        builder.box(box.getCorner000(BoxShapeBuilder.obtainV3()), box.getCorner010(BoxShapeBuilder.obtainV3()), box.getCorner100(BoxShapeBuilder.obtainV3()), box.getCorner110(BoxShapeBuilder.obtainV3()), box.getCorner001(BoxShapeBuilder.obtainV3()), box.getCorner011(BoxShapeBuilder.obtainV3()), box.getCorner101(BoxShapeBuilder.obtainV3()), box.getCorner111(BoxShapeBuilder.obtainV3()));
    ...
    public static void build(MeshPartBuilder builder, Vector3 corner000, Vector3 corner010, Vector3 corner100, Vector3 corner110, Vector3 corner001, Vector3 corner011, Vector3 corner101, Vector3 corner111) {
        if ((builder.getAttributes().getMask() & 0x198L) == 0L) {
