...
extends BaseShapeBuilder {
    ...
    public static void build(MeshPartBuilder builder, Vector3 corner00, Vector3 corner10, Vector3 corner11, Vector3 corner01, Vector3 normal, int divisionsU, int divisionsV) {
        PatchShapeBuilder.build(builder, vertTmp1.set(corner00, normal, null, null).setUV(0.0f, 1.0f), vertTmp2.set(corner10, normal, null, null).setUV(1.0f, 1.0f), vertTmp3.set(corner11, normal, null, null).setUV(1.0f, 0.0f), vertTmp4.set(corner01, normal, null, null).setUV(0.0f, 0.0f), divisionsU, divisionsV);
    }
