...
extends GL31 {
    ...
    public void glCopyImageSubData(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15);

    public void glDebugMessageControl(int var1, int var2, int var3, IntBuffer var4, boolean var5);

    public void glDebugMessageInsert(int var1, int var2, int var3, int var4, String var5);

    public void glDebugMessageCallback(DebugProc var1);

    public int glGetDebugMessageLog(int var1, IntBuffer var2, IntBuffer var3, IntBuffer var4, IntBuffer var5, IntBuffer var6, ByteBuffer var7);

    public void glPushDebugGroup(int var1, int var2, String var3);

    public void glPopDebugGroup();

    public void glObjectLabel(int var1, int var2, String var3);

    public String glGetObjectLabel(int var1, int var2);

    public long glGetPointerv(int var1);

    public void glEnablei(int var1, int var2);

    public void glDisablei(int var1, int var2);

    public void glBlendEquationi(int var1, int var2);

    public void glBlendEquationSeparatei(int var1, int var2, int var3);

    public void glBlendFunci(int var1, int var2, int var3);

    public void glBlendFuncSeparatei(int var1, int var2, int var3, int var4, int var5);

    public void glColorMaski(int var1, boolean var2, boolean var3, boolean var4, boolean var5);

    public boolean glIsEnabledi(int var1, int var2);

    public void glDrawElementsBaseVertex(int var1, int var2, int var3, Buffer var4, int var5);

    public void glDrawRangeElementsBaseVertex(int var1, int var2, int var3, int var4, int var5, Buffer var6, int var7);

    public void glDrawElementsInstancedBaseVertex(int var1, int var2, int var3, Buffer var4, int var5, int var6);

    public void glDrawElementsInstancedBaseVertex(int var1, int var2, int var3, int var4, int var5, int var6);

    public void glFramebufferTexture(int var1, int var2, int var3, int var4);

    public int glGetGraphicsResetStatus();

    public void glReadnPixels(int var1, int var2, int var3, int var4, int var5, int var6, int var7, Buffer var8);

    public void glGetnUniformfv(int var1, int var2, FloatBuffer var3);

    public void glGetnUniformiv(int var1, int var2, IntBuffer var3);

    public void glGetnUniformuiv(int var1, int var2, IntBuffer var3);

    public void glMinSampleShading(float var1);

    public void glPatchParameteri(int var1, int var2);

    public void glTexParameterIiv(int var1, int var2, IntBuffer var3);

    public void glTexParameterIuiv(int var1, int var2, IntBuffer var3);

    public void glGetTexParameterIiv(int var1, int var2, IntBuffer var3);

    public void glGetTexParameterIuiv(int var1, int var2, IntBuffer var3);

    public void glSamplerParameterIiv(int var1, int var2, IntBuffer var3);

    public void glSamplerParameterIuiv(int var1, int var2, IntBuffer var3);

    public void glGetSamplerParameterIiv(int var1, int var2, IntBuffer var3);

    public void glGetSamplerParameterIuiv(int var1, int var2, IntBuffer var3);

    public void glTexBuffer(int var1, int var2, int var3);

    public void glTexBufferRange(int var1, int var2, int var3, int var4, int var5);

    public void glTexStorage3DMultisample(int var1, int var2, int var3, int var4, int var5, int var6, boolean var7);

    public static interface DebugProc {
        public void onMessage(int var1, int var2, int var3, int var4, String var5);
    }
}
