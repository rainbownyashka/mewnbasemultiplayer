...
public class Frustum {
    ...
    public boolean boundsInFrustum(OrientedBoundingBox obb) {
        int len2 = this.planes.length;
        for (int i = 0; i < len2; ++i) {
            if (this.planes[i].testPoint(obb.getCorner000(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner001(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner010(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner011(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner100(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner101(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner110(tmpV)) != Plane.PlaneSide.Back || this.planes[i].testPoint(obb.getCorner111(tmpV)) != Plane.PlaneSide.Back) continue;
            return false;
        }
        return true;
    }
