...
implements Serializable {
    ...
    public Matrix3 inv() {
        ...
        float[] val = this.val;
        float v00 = val[4] * val[8] - val[5] * val[7];
        float v10 = val[2] * val[7] - val[1] * val[8];
        float v20 = val[1] * val[5] - val[2] * val[4];
        float v01 = val[5] * val[6] - val[3] * val[8];
        float v11 = val[0] * val[8] - val[2] * val[6];
        float v21 = val[2] * val[3] - val[0] * val[5];
        float v02 = val[3] * val[7] - val[4] * val[6];
        float v12 = val[1] * val[6] - val[0] * val[7];
        float v22 = val[0] * val[4] - val[1] * val[3];
        val[0] = inv_det * v00;
        val[1] = inv_det * v10;
        val[2] = inv_det * v20;
        val[3] = inv_det * v01;
