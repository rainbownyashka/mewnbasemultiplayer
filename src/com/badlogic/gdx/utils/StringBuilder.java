...
CharSequence {
    ...
    public int indexOfIgnoreCase(String subString, int start) {
        ...
        while (true) {
            ...
            int o1 = i;
            int o2 = 0;
            while (++o2 < subCount && ((c = this.chars[++o1]) == (upper = Character.toUpperCase(subString.charAt(o2))) || c == Character.toLowerCase(upper))) {
            }
            if (o2 == subCount) {
                return i;
            }
    ...
    public boolean contains(String subString) {
        return this.indexOf(subString, 0) != -1;
    }

    public boolean containsIgnoreCase(String subString) {
        return this.indexOfIgnoreCase(subString, 0) != -1;
    }
