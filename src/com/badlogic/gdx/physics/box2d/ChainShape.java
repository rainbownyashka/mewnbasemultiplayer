...
extends Shape {
    ...
    public void createChain(float[] vertices) {
        this.jniCreateChain(this.addr, vertices, 0, vertices.length / 2);
        this.isLooped = false;
    }

    public void createChain(float[] vertices, int offset, int length) {
        this.jniCreateChain(this.addr, vertices, offset, length / 2);
        this.isLooped = false;
    }
    ...
    public void createChain(Vector2[] vertices) {
        ...
        this.jniCreateChain(this.addr, verts, 0, vertices.length);
        this.isLooped = false;
    }

    private native void jniCreateChain(long var1, float[] var3, int var4, int var5);
