...
extends ReachOrientation<T> {
    ...
    protected SteeringAcceleration<T> calculateRealSteering(SteeringAcceleration<T> steering2) {
        return this.face(steering2, this.target.getPosition());
    }

    protected SteeringAcceleration<T> face(SteeringAcceleration<T> steering2, T targetPosition) {
        Object toTarget = steering2.linear.set(targetPosition).sub(this.owner.getPosition());
        ...
        return this.reachOrientation(steering2, orientation);
    }
