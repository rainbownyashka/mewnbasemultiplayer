...
public abstract class SteeringBehavior<T extends Vector<T>> {
    ...
    public SteeringAcceleration<T> calculateSteering(SteeringAcceleration<T> steering2) {
        return this.isEnabled() ? this.calculateRealSteering(steering2) : steering2.setZero();
    }
