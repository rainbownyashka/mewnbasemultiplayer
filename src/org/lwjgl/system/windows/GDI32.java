...
public class GDI32 {
    ...
    public static int nChoosePixelFormat(long hdc, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nChoosePixelFormat(hdc, pixelFormatDescriptor, __functionAddress);
    }

    public static int ChoosePixelFormat(@NativeType(value="HDC") long hdc, @NativeType(value="PIXELFORMATDESCRIPTOR const *") PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
    ...
    public static int nDescribePixelFormat(long hdc, int pixelFormat, int bytes, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(hdc, pixelFormat, bytes, pixelFormatDescriptor, __functionAddress);
    }

    public static int DescribePixelFormat(@NativeType(value="HDC") long hdc, int pixelFormat, @NativeType(value="UINT") int bytes, @Nullable @NativeType(value="LPPIXELFORMATDESCRIPTOR") PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(hdc, pixelFormat, bytes, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
    }

    public static int DescribePixelFormat(@NativeType(value="HDC") long hdc, int pixelFormat, @Nullable @NativeType(value="LPPIXELFORMATDESCRIPTOR") PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(hdc, pixelFormat, PIXELFORMATDESCRIPTOR.SIZEOF, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
    }

    public static native int nGetPixelFormat(long var0, long var2);

    public static int GetPixelFormat(@NativeType(value="HDC") long hdc) {
        long __functionAddress = Functions.GetPixelFormat;
        if (Checks.CHECKS) {
            Checks.check(hdc);
        }
        return org.lwjgl.system.windows.GDI32.nGetPixelFormat(hdc, __functionAddress);
    }
    ...
    public static int nSetPixelFormat(long hdc, int pixelFormat, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nSetPixelFormat(hdc, pixelFormat, pixelFormatDescriptor, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetPixelFormat(@NativeType(value="HDC") long hdc, int pixelFormat, @Nullable @NativeType(value="PIXELFORMATDESCRIPTOR const *") PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        return org.lwjgl.system.windows.GDI32.nSetPixelFormat(hdc, pixelFormat, MemoryUtil.memAddressSafe(pixelFormatDescriptor)) != 0;
    }

    public static native int nSwapBuffers(long var0, long var2);

    @NativeType(value="BOOL")
    public static boolean SwapBuffers(@NativeType(value="HDC") long dc) {
        long __functionAddress = Functions.SwapBuffers;
        if (Checks.CHECKS) {
            Checks.check(dc);
        }
        return org.lwjgl.system.windows.GDI32.nSwapBuffers(dc, __functionAddress) != 0;
    }
