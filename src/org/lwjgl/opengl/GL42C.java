...
extends GL41C {
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int bufferIndex, @NativeType(value="GLenum") int pname, @NativeType(value="GLint *") IntBuffer params) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)params, 1);
        }
        GL42C.nglGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, MemoryUtil.memAddress(params));
    }
    ...
    public static int glGetActiveAtomicCounterBufferi(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int bufferIndex, @NativeType(value="GLenum") int pname) {
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="GLenum") int type, @NativeType(value="void const *") ByteBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseInstance(mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") ByteBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") ShortBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") IntBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="GLenum") int type, @NativeType(value="void const *") ByteBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLint") int basevertex, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") ByteBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLint") int basevertex, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") ShortBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLint") int basevertex, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int mode, @NativeType(value="void const *") IntBuffer indices, @NativeType(value="GLsizei") int primcount, @NativeType(value="GLint") int basevertex, @NativeType(value="GLuint") int baseinstance) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
    }
    ...
    public static void glGetInternalformativ(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int pname, @NativeType(value="GLint *") IntBuffer params) {
        GL42C.nglGetInternalformativ(target, internalformat, pname, params.remaining(), MemoryUtil.memAddress(params));
    }
    ...
    public static int glGetInternalformati(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int pname) {
        ...
        try {
            IntBuffer params = stack.callocInt(1);
            GL42C.nglGetInternalformativ(target, internalformat, pname, 1, MemoryUtil.memAddress(params));
            int n = params.get(0);
            return n;
        }
        finally {
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int bufferIndex, @NativeType(value="GLenum") int pname, @NativeType(value="GLint *") int[] params) {
        long __functionAddress = GL.getICD().glGetActiveAtomicCounterBufferiv;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(params, 1);
        }
        JNI.callPV(program, bufferIndex, pname, params, __functionAddress);
    }
