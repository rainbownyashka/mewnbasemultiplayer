...
public class NVBlendEquationAdvanced {
    ...
    public static final int GL_UNCORRELATED_NV = 34081;
    ...
    public static final int GL_XOR_NV = 5382;
    ...
    public static final int GL_RED_NV = 6403;
    public static final int GL_GREEN_NV = 6404;
    public static final int GL_BLUE_NV = 6405;

    protected NVBlendEquationAdvanced() {
        throw new UnsupportedOperationException();
    }

    public static native void glBlendParameteriNV(@NativeType(value="GLenum") int var0, @NativeType(value="GLint") int var1);
