...
public class ARBDrawBuffers {
    ...
    public static void glDrawBuffersARB(@NativeType(value="GLenum const *") IntBuffer bufs) {
        ARBDrawBuffers.nglDrawBuffersARB(bufs.remaining(), MemoryUtil.memAddress(bufs));
    }

    public static void glDrawBuffersARB(@NativeType(value="GLenum const *") int[] bufs) {
