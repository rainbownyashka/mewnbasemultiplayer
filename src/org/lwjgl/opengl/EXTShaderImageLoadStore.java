...
public class EXTShaderImageLoadStore {
    ...
    public static native void glBindImageTextureEXT(@NativeType(value="GLuint") int var0, @NativeType(value="GLuint") int var1, @NativeType(value="GLint") int var2, @NativeType(value="GLboolean") boolean var3, @NativeType(value="GLint") int var4, @NativeType(value="GLenum") int var5, @NativeType(value="GLint") int var6);

    public static native void glMemoryBarrierEXT(@NativeType(value="GLbitfield") int var0);
