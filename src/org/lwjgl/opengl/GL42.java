...
extends GL41 {
    ...
    public static void glBindImageTexture(@NativeType(value="GLuint") int unit, @NativeType(value="GLuint") int texture, @NativeType(value="GLint") int level, @NativeType(value="GLboolean") boolean layered, @NativeType(value="GLint") int layer, @NativeType(value="GLenum") int access, @NativeType(value="GLenum") int format) {
        GL42C.glBindImageTexture(unit, texture, level, layered, layer, access, format);
    }

    public static void glMemoryBarrier(@NativeType(value="GLbitfield") int barriers) {
