        ...
        public void read_scalefactor(Bitstream stream, Header header) {
            ...
            if (this.channel2_allocation != 0) {
                switch (this.channel2_scfsi) {
                    case 0: {
                        this.channel2_scalefactor1 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.channel2_scalefactor2 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.channel2_scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        break;
                    }
                    case 1: {
                        this.channel2_scalefactor1 = this.channel2_scalefactor2 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.channel2_scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        break;
                    }
                    case 2: {
                        this.channel2_scalefactor2 = this.channel2_scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
    ...
    extends LayerIDecoder.Subband {
        ...
        public void read_scalefactor(Bitstream stream, Header header) {
            if (this.allocation != 0) {
                switch (this.scfsi) {
                    case 0: {
                        this.scalefactor1 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.scalefactor2 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        break;
                    }
                    case 1: {
                        this.scalefactor1 = this.scalefactor2 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        this.scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                        break;
                    }
                    case 2: {
                        this.scalefactor2 = this.scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
